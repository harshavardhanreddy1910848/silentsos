...
function generateReport() {
  console.log("=== COMPILING 325 TEST CASES FOR APPIUM EXPORT ===");
  ...
  // ----------------------------------------------------
  const dashboardAOA = [
    ["SilentSOS Mobile App Platform - Appium Testing Executive Summary"],
    [],
    ["Deployment Target", "Capacitor Mobile Hybrid App (Android / iOS)"],
  ...
  // Output to path
  const outPath = path.join(__dirname, 'appium_test_results.xlsx');
